...
/**
 * check_elf - checks if a fike is an ELF filke
 * @e_ident: pointer to an array containing the ELF magic numbers
 *
 * Description: If the filke is not an ELF file - exit code 98
 */
void check_elf(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: poinbter to an array containing OS/ABI
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
 ...
 * @e_ident: pointer to an array containing ELF clas
 *
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 * @elf: file descriptor for ELF header
 *
